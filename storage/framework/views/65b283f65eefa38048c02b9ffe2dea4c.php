...
<?php $__env->startSection('title', 'Sửa điểm trả'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dropoff-points.index')); ?>" class="text-decoration-none">Danh mục gốc</a></li>
            ...
            <div class="card shadow-sm border-0 rounded-4 p-4">
                <div class="mb-4">
                    <h4 class="fw-bold m-0 text-dark">Chỉnh sửa Điểm trả</h4>
                    <p class="text-muted small">Cập nhật thông tin bến xe/điểm dừng trong hệ thống</p>
                </div>

                <form action="<?php echo e(route('admin.dropoff-points.update', $dropoffPoint->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($loc->id); ?>" <?php echo e((old('location_id', $dropoffPoint->location_id) == $loc->id) ? 'selected' : ''); ?>>
                                    <?php echo e($loc->name); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold small text-muted">Tên điểm trả</label>
                        <input type="text" name="name" value="<?php echo e(old('name', $dropoffPoint->name)); ?>" 
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Số nhà, tên đường..."><?php echo e(old('address', $dropoffPoint->address)); ?></textarea>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/dropoff_points/edit.blade.php ENDPATH**/ ?>