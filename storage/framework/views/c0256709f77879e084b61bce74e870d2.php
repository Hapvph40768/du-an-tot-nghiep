...
<?php $__env->startSection('content-main'); ?>
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('admin.pickup-points.create')); ?>" class="btn btn-primary px-4 py-2"
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="<?php echo e(route('admin.pickup-points.edit', $point->id)); ?>"
                                        class="btn btn-sm btn-light border text-primary"><i class='bx bx-edit'></i></a>
                                    <form action="<?php echo e(route('admin.pickup-points.destroy', $point->id)); ?>" method="POST"
                                        class="d-inline">
                                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                        <button type="submit" class="btn btn-sm btn-light border text-danger"
                                            onclick="return confirm('Xóa điểm này khỏi hệ thống?')"><i
