            ...
            <form action="<?php echo e(route('customer.parcels.store')); ?>" method="POST">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="sender_name" id="sender_name" value="<?php echo e(old('sender_name', Auth::user()->name ?? '')); ?>" required
                    ...
                    <div>
                        ...
                        <input type="text" name="sender_phone" id="sender_phone" value="<?php echo e(old('sender_phone', Auth::user()->phone ?? '')); ?>" required
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-sm" />
                    </div>

                    <div>
                        <label for="receiver_name" class="block text-gray-700 font-medium mb-2">Người nhận</label>
                        <input type="text" name="receiver_name" id="receiver_name" value="<?php echo e(old('receiver_name')); ?>" required
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-sm" />
                    </div>

                    <div>
                        <label for="receiver_phone" class="block text-gray-700 font-medium mb-2">Số điện thoại người nhận</label>
                        <input type="text" name="receiver_phone" id="receiver_phone" value="<?php echo e(old('receiver_phone')); ?>" required
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-sm" />
                    </div>
                </div>
                ...
                <div class="grid gap-6 md:grid-cols-3 mt-6">
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="weight" id="weight" value="<?php echo e(old('weight')); ?>" required
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-sm" />
                    </div>

                    <div>
                        <label for="price" class="block text-gray-700 font-medium mb-2">Giá ước tính (VNĐ)</label>
                        <input type="number" step="1000" min="0" name="price" id="price" value="<?php echo e(old('price')); ?>" required
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-sm" />
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="sender_name" value="<?php echo e(old('sender_name')); ?>" required class="w-full px-4 py-2 border rounded-lg focus:ring-amber-500 focus:border-amber-500">
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Số điện thoại <span class="text-red-500">*</span></label>
                            <input type="text" name="sender_phone" value="<?php echo e(old('sender_phone')); ?>" required class="w-full px-4 py-2 border rounded-lg focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    </div>
...
>>>>>>> 641ec6fe9d583cdcc402e365a7945187f0de616d
                    </div>
                </div>
...
<<<<<<< HEAD
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-sm"><?php echo e(old('description')); ?></textarea>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        <div>
                            ...
                            <select name="route_id" required class="w-full px-4 py-2 border rounded-lg focus:ring-amber-500 focus:border-amber-500">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <option value="<?php echo e($route->id); ?>" <?php echo e(old('route_id') == $route->id ? 'selected' : ''); ?>>
                                        <?php echo e($route->startLocation->name ?? '...'); ?> &rarr; <?php echo e($route->endLocation->name ?? '...'); ?>
