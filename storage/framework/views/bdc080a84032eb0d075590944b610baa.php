                    ...
                    <div class="md:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="selected_departure_date" required value="<?php echo e($trip->trip_date); ?>" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-amber-500">
                            </div>
...
<?php echo $__env->make('layout.customer.CustomerLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\du-an-tot-nghiep-main\resources\views/customer/trips/show.blade.php ENDPATH**/ ?>