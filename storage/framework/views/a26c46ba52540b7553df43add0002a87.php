    ...
    <section id="search" class="gradient-hero bus-pattern text-white py-12 md:py-16">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl card-shadow p-6 max-w-4xl mx-auto">
                <form id="search-form" action="<?php echo e(route('customer.trips.search')); ?>" method="GET" class="space-y-4">
                    ...
                    <div class="flex justify-center mt-6">
                        <button type="submit"
                            class="w-full md:w-1/3 btn-primary text-white font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-2">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all group">
                    <img src="./images/hanoi-17486566616582033334984.jpg" alt="Hà Nội" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="p-5">
                        ...
                        <a href="<?php echo e(route('customer.home')); ?>" class="text-amber-600 font-medium hover:text-amber-700 flex items-center gap-1">
                ...
                <!-- Route Card -->
                <div class="bg-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all group">
                    <img src="./images/39-4595-6687.jpg" alt="Đà Lạt" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="p-5">
                        <div class="flex items-center gap-2 mb-2">
                ...
                <!-- Route Card -->
                <div class="bg-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all group">
                    <img src="./images/du-lich-sapa.jpg" alt="Sapa" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="p-5">
                        <div class="flex items-center gap-2 mb-2">
                            <span class="font-bold text-lg">Hà Nội</span>
                            <i class='bx bx-transfer-alt text-amber-500'></i>
                ...
                <!-- Route Card -->
                <div class="bg-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all group">
                    <img src="./images/z6223362576777_15a21ef00a73b25851a3972d86795475_20250113104122.jpg" alt="Nha Trang" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="p-5">
                        <div class="flex items-center gap-2 mb-2">
                            <span class="font-bold text-lg">Hồ Chí Minh</span>
                            <i class='bx bx-transfer-alt text-amber-500'></i>
            ...
            <div class="text-center mt-10">
                <a href="#search" class="inline-block border-2 border-amber-500 text-amber-600 hover:bg-amber-500 hover:text-white font-medium px-8 py-3 rounded-xl transition-colors">
    ...
    <section id="features" class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-2xl shadow-sm text-center transform hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <p class="text-gray-600">Ứng dụng công nghệ hàng đầu, quá trình tìm chuyến và thanh toán chỉ mất 1 phút.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm text-center transform hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <p class="text-gray-600">Hỗ trợ giữ chỗ thanh toán trong 15 phút, yên tâm 100% khi mua vé các dịp lễ Tết.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm text-center transform hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <p class="text-gray-600">Cam kết lịch trình chặt chẽ, khởi hành đúng khung giờ như trên vé bạn chọn.</p>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layout.customer.CustomerLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\du-an-tot-nghiep-main\resources\views/customer/home/index.blade.php ENDPATH**/ ?>