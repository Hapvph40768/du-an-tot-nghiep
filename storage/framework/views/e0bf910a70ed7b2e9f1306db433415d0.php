                    ...
                    <form action="<?php echo e(route('admin.vehicles.store')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="license_plate"
                                class="form-control rounded-3 <?php $__errorArgs = ['license_plate'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="type"
                                class="form-control rounded-3 <?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="form-label fw-bold small"><?php echo e(__('total')); ?> số ghế</label>
                                <input type="number" name="total_seats"
                                    class="form-control rounded-3 <?php $__errorArgs = ['total_seats'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phone_vehicles"
                                    class="form-control rounded-3 <?php $__errorArgs = ['phone_vehicles'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <optgroup label="<?php echo e($parking->name); ?> (<?php echo e($parking->location); ?>)">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $parking->slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <option value="<?php echo e($slot->id); ?>"
                                                        <?php echo e(old('parking_slot_id') == $slot->id ? 'selected' : ''); ?>>
                                                        <?php echo e($slot->slot_code); ?> - <?php echo e($slot->zone); ?></option>
                        ...
                        <div class="mt-4 pt-3 border-top">
                            ...
                            <a href="<?php echo e(route('admin.vehicles.index')); ?>" class="btn btn-light px-4 border ms-2"
                                style="border-radius: 10px; height: 45px;"><?php echo e(__('cancel')); ?></a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/vehicles/create.blade.php ENDPATH**/ ?>