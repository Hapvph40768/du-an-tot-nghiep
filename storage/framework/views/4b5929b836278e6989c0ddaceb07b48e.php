            ...
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        <a href="<?php echo e(route('customer.home')); ?>" class="w-10 h-10 bg-amber-500 rounded-lg flex items-center justify-center hover:bg-amber-600 transition-colors">
                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M4 16c0 .88.39 1.67 1 2.22V20c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h8v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1.78c.61-.55 1-1.34 1-2.22V6c0-3.5-3.58-4-8-4s-8 .5-8 4v10zm3.5 1c-.83 0-1.5-.67-1.5-1.5S6.67 14 7.5 14s1.5.67 1.5 1.5S8.33 17 7.5 17zm9 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm1.5-6H6V6h12v5z" />
                            </svg>
                        </a>
                        <a href="<?php echo e(route('customer.home')); ?>" id="footer-brand" class="font-bold text-lg hover:text-amber-400 py-1">Mạnh Hùng</a>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li><a href="<?php echo e(route('customer.home')); ?>" class="hover:text-amber-400 transition-colors">Đặt vé online</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        ...
                        <li><a href="javascript:void(0)" onclick="alert('Tính năng đang phát triển')" class="hover:text-amber-400 transition-colors">Câu hỏi thường gặp</a></li>
                        <li><a href="javascript:void(0)" onclick="alert('Tính năng đang phát triển')" class="hover:text-amber-400 transition-colors">Điều khoản sử dụng</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <a href="javascript:void(0)" onclick="alert('Tính năng đang phát triển')" class="flex items-center gap-3 bg-gray-800 px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors">
...
<?php /**PATH C:\laragon\www\du-an-tot-nghiep-main\resources\views/layout/customer/blocks/footer.blade.php ENDPATH**/ ?>