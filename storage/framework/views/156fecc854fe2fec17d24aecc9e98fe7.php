...
<div class="top-header">
    <div class="header-title">
        <h1>Sửa Tuyến Xe</h1>
        <p>Cập nhật thông tin tuyến xe #<?php echo e($route->id); ?></p>
    </div>
</div>
        ...
        <form action="<?php echo e(route('routes.update', $route->id)); ?>" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                <div>
                    ...
                    <select name="start_location_id" style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;" required>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <option value="<?php echo e($location->id); ?>" <?php if($route->start_location_id == $location->id): echo 'selected'; endif; ?>><?php echo e($location->name); ?></option>
                ...
                <div>
                    ...
                    <select name="end_location_id" style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;" required>
                        <option value="">-- Chọn điểm --</option>
                        <?php $__empty_1 = true; $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <option value="<?php echo e($location->id); ?>" <?php if($route->end_location_id == $location->id): echo 'selected'; endif; ?>><?php echo e($location->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <option value="" disabled>Chưa có địa điểm</option>
                        <?php endif; ?>
                    </select>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 24px;">
                <div>
                    ...
                    <input type="number" name="distance_km" style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;" value="<?php echo e(old('distance_km', $route->distance_km)); ?>" min="1" required>
                </div>
                <div>
                    ...
                    <input type="number" name="estimated_time" style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;" value="<?php echo e(old('estimated_time', $route->estimated_time)); ?>" min="1" required>
                </div>
            </div>
