    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.trips.index')); ?>" class="text-decoration-none">Danh sách chuyến</a></li>
                    <li class="breadcrumb-item active">Tạo chuyến mới</li>
                </ol>
            </nav>

            <div class="card shadow-sm border-0 rounded-4 p-4">
                <h3 class="fw-bold mb-4 text-dark"><i class='bx bx-calendar-plus text-primary'></i> Lên lịch Chuyến xe mới</h3>
                ...
                <form action="<?php echo e(route('admin.trips.store')); ?>" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <label class="form-label fw-bold small text-muted">Chọn Tuyến đường <span class="text-danger">*</span></label>
                            <select name="route_id" class="form-select rounded-3 shadow-sm <?php $__errorArgs = ['route_id'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted">Chọn Xe vận hành <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted">Tài xế phụ trách <span class="text-danger">*</span></label>
                            <select name="driver_id" class="form-select rounded-3 <?php $__errorArgs = ['driver_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted">Giá vé niêm yết (VNĐ) <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select rounded-3">
                                <option value="active" <?php echo e(old('status') == 'active' ? 'selected' : ''); ?>>Mở bán (Active)</option>
                                <option value="cancelled" <?php echo e(old('status') == 'cancelled' ? 'selected' : ''); ?>>Tạm dừng/Hủy</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 pt-3 border-top d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.trips.index')); ?>" class="btn btn-light px-4 border" style="border-radius: 10px;">
                            Hủy bỏ
                        </a>
                    </div>
                </form>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\du-an-tot-nghiep-main\resources\views/admin/trips/create.blade.php ENDPATH**/ ?>