<?php $__env->startSection('title', 'Thêm điểm trả vào kho'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card shadow-sm border-0 rounded-4 p-4">
                ...
                <form action="<?php echo e(route('admin.dropoff-points.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/dropoff_points/create.blade.php ENDPATH**/ ?>