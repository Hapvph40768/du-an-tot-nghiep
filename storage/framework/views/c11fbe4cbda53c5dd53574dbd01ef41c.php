...
<head>
    ...
    <title>Assistant Portal - Mạnh Hùng</title>
        ...
        <div class="w-72 bg-white border-r border-gray-200 flex flex-col shadow-xl z-50">
            ...
            <div class="px-6 py-8 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    <div class="w-11 h-11 bg-blue-500 rounded-2xl flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-600 font-medium -mt-1">DRIVER PORTAL</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-5 border-b border-gray-100 bg-blue-50">
                <div class="flex items-center gap-4">
                    <div
                        class="w-12 h-12 bg-blue-600 text-white rounded-2xl flex items-center justify-center text-2xl font-bold">
                        <?php echo e(strtoupper(substr(Auth::user()->name ?? 'D', 0, 1))); ?>

                    </div>
                    <a href="<?php echo e(route('assistant.profile')); ?>">
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="<?php echo e(route('assistant.trips.index')); ?>"
                            class="<?php echo e(request()->routeIs('assistant.trips.*') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' : 'text-gray-600 hover:bg-gray-50'); ?> 
                    ...
                    <li>
                        <a href="<?php echo e(route('assistant.history.index')); ?>"
                            class="<?php echo e(request()->routeIs('assistant.history.*') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' : 'text-gray-600 hover:bg-gray-50'); ?> 
                           flex items-center gap-3 px-5 py-4 rounded-2xl font-medium transition-all">
                    ...
                    <li>
                        <a href="<?php echo e(route('assistant.revenue.index')); ?>"
                            class="<?php echo e(request()->routeIs('assistant.revenue.*') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' : 'text-gray-600 hover:bg-gray-50'); ?> 
                           flex items-center gap-3 px-5 py-4 rounded-2xl font-medium transition-all">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header
                ...
                <div class="flex items-center gap-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-800"><?php echo $__env->yieldContent('page-title', 'Assistant Portal'); ?></h1>
                </div>
            </header>
            ...
            <footer class="bg-white border-t border-gray-200 py-4 px-8 text-center text-xs text-gray-400">
                © 2026 Nhà xe Mạnh Hùng - Assistant Portal • Phiên bản 1.0
            </footer>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\du-an-tot-nghiep\resources\views/layout/assistant/AssistantLayout.blade.php ENDPATH**/ ?>