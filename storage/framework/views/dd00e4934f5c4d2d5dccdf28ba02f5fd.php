...
<?php $__env->startSection('content-main'); ?>
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div class="bg-gradient-to-br from-amber-500 to-orange-500 rounded-3xl p-6 text-white shadow-lg relative overflow-hidden">
                <div class="relative z-10">
                    <p class="text-amber-100 font-medium mb-1">Tổng doanh thu</p>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 sm:p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <h2 class="text-xl font-semibold text-gray-800 flex items-center gap-2">
                        <i class='bx bx-bar-chart-alt-2 text-amber-500'></i> Doanh thu theo chuyến
                    </h2>
                </div>
                                ...
                                <tr class="hover:bg-amber-50/30 transition duration-150">
                                    ...
                                    <td class="py-5 px-6">
                                        <p class="font-medium text-gray-800 flex items-center gap-2">
                                            ...
                                            <i class='bx bx-right-arrow-alt text-amber-400'></i> 
...
<?php echo $__env->make('layout.driver.DriverLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\du-an-tot-nghiep\resources\views/driver/trips/revenue.blade.php ENDPATH**/ ?>