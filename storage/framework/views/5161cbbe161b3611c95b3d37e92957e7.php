        ...
        <div class="w-72 bg-white border-r border-gray-200 flex flex-col shadow-xl z-50">
            ...
            <nav class="flex-1 px-3 py-6 overflow-y-auto">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="<?php echo e(route('driver.history.index')); ?>"
                            class="<?php echo e(request()->routeIs('driver.history.*') ? 'bg-amber-50 text-amber-700 border-l-4 border-amber-500' : 'text-gray-600 hover:bg-gray-50'); ?> 
                           flex items-center gap-3 px-5 py-4 rounded-2xl font-medium transition-all">
                    ...
                    <li>
                        <a href="<?php echo e(route('driver.revenue.index')); ?>"
