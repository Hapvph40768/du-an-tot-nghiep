...
<?php $__env->startSection('title', 'Thêm điểm đón mới'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="pt-3 border-top d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.trips.pickup_points.index', $trip->id)); ?>" class="btn btn-light px-4 border" style="border-radius: 10px;">Hủy</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/trips/pickup_points/create.blade.php ENDPATH**/ ?>