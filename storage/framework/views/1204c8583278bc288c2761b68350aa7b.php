        ...
        <div class="row">
                        ...
                        <table class="table table-hover">
                            <thead class="sticky-top bg-white">
                                <tr class="small text-muted">
                                    <th width="50">Chọn</th>
                                    <th><?php echo e(__('name')); ?> điểm / Địa chỉ</th>
                                    <th>Tỉnh</th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="col-md-5">
                <div class="card shadow-sm border-0 rounded-4 p-4 sticky-top" style="top: 20px;">
                    <h5 class="fw-bold mb-3"><?php echo e(__('trajectory_mobile')); ?> hiện tại</h5>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/trips/pickup_points/index.blade.php ENDPATH**/ ?>