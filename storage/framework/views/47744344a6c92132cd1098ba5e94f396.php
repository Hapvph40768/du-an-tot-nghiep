                    ...
                    <div class="md:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="selected_departure_date" readonly value="<?php echo e($trip->trip_date); ?>" class="w-full px-4 py-2 border rounded-lg bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none">
                            </div>
