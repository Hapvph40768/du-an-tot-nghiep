                ...
                <div class="grid md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            ...
                            <div class="mb-2">
                                ...
                                <select name="pickup_point_id" id="pickup_point_select" required
                                    ...
                                    <option value="" class="text-gray-500" data-address="<?php echo e($trip->route->departureLocation->name ?? 'Bến xe'); ?>">-- Chọn điểm đón --</option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $trip->pickupPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <option value="<?php echo e($point->id); ?>" class="text-gray-900"
                                            data-address="<?php echo e($point->address ? $point->address . ', ' . $point->name : $point->name); ?>"
                                            <?php echo e(old('pickup_point_id') == $point->id ? 'selected' : ''); ?>>
                                            <?php echo e(\Carbon\Carbon::parse($point->pivot->pickup_time ?? $trip->departure_time)->format('H:i')); ?> - <?php echo e($point->name); ?>

                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($point->address): ?> (<?php echo e($point->address); ?>) <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </option>
                            ...
                            <div class="mt-4">
                                ...
                                <select name="dropoff_point_id" id="dropoff_point_select"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $trip->dropoffPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <option value="<?php echo e($point->id); ?>" class="text-gray-900"
                                            <?php echo e(old('dropoff_point_id') == $point->id ? 'selected' : ''); ?>>
                                            <?php echo e($point->name); ?><?php echo e($point->address ? ' (' . $point->address . ')' : ''); ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 self-start sticky top-6">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="number" name="ticket_quantity" id="ticket-qty-input"
                                    min="1" max="<?php echo e(min(4, $availableSeats)); ?>" value="1"
                        ...
                        <div class="border-t border-gray-200 pt-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                                <a href="<?php echo e(route('login')); ?>" class="block text-center w-full py-3 rounded-lg font-bold text-white bg-amber-500 hover:bg-amber-600 transition-colors shadow-sm">
                                    Đăng nhập để đặt vé
                                </a>
                            <?php else: ?>
