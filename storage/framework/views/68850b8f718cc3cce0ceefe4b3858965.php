        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-white/50 text-sm mt-1">Mã đơn: #<?php echo e($parcel->id); ?></p>
                </div>
            </div>
                ...
                <div class="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between border-b border-white/5 pb-3">
                                ...
                                <span class="text-white font-medium"><?php echo e($parcel->sender_name); ?></span>
                            </div>
                            <div class="flex justify-between border-b border-white/5 pb-3">
                                <span class="text-white/50 text-sm">Số điện thoại</span>
                                <span class="text-white font-medium"><?php echo e($parcel->sender_phone); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between border-b border-white/5 pb-3">
                                <span class="text-white/50 text-sm">Họ tên</span>
                                <span class="text-white font-medium"><?php echo e($parcel->receiver_name); ?></span>
                            </div>
                            <div class="flex justify-between border-b border-white/5 pb-3">
                                <span class="text-white/50 text-sm">Số điện thoại</span>
                                <span class="text-white font-medium"><?php echo e($parcel->receiver_phone); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            <div class="flex justify-between border-b border-white/5 pb-3">
                                ...
                                <span class="text-white font-medium"><?php echo e($parcel->weight); ?> kg</span>
                            </div>
                            <div class="flex justify-between border-b border-white/5 pb-3">
                                <span class="text-white/50 text-sm">Tổng cước phí</span>
                                <span
                                    class="text-brand-primary font-black text-lg"><?php echo e(number_format($parcel->price, 0, ',', '.')); ?>đ</span>
                            </div>
                            <div class="flex justify-between border-b border-white/5 pb-3">
                                <span class="text-white/50 text-sm">Thời gian tạo</span>
                                <span class="text-white/80"><?php echo e($parcel->created_at->format('d/m/Y H:i')); ?></span>
                            </div>
                        </div>
                        <div class="bg-white/5 rounded-xl p-4 border border-white/5">
                            <span class="block text-white/50 text-xs uppercase font-bold mb-2">Mô tả hàng hóa</span>
                            <p class="text-white/80 text-sm"><?php echo e($parcel->description ?: 'Không có mô tả'); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 sm:p-8 bg-brand-primary/5 border-t border-white/5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div class="bg-black/20 rounded-xl p-4 border border-white/5">
                                ...
                                <span
                                    class="text-white font-bold"><?php echo e(\Carbon\Carbon::parse($parcel->trip->departure_time)->format('H:i')); ?>

                                    - <?php echo e(\Carbon\Carbon::parse($parcel->trip->trip_date)->format('d/m/Y')); ?></span>
                            </div>
                            <div class="bg-black/20 rounded-xl p-4 border border-white/5">
                                <span class="block text-white/50 text-xs mb-1">Biển số xe</span>
                                <span class="text-white font-bold"><?php echo e($parcel->trip->vehicle->license_plate ?? 'N/A'); ?></span>
                            </div>
                            <div class="bg-black/20 rounded-xl p-4 border border-white/5">
                                <span class="block text-white/50 text-xs mb-1">Lái xe</span>
                                <span class="text-white font-bold"><?php echo e($parcel->trip->driver->name ?? 'N/A'); ?> <br><span
                                        class="text-sm text-brand-primary"><?php echo e($parcel->trip->driver->phone ?? ''); ?></span></span>
                            </div>
                        </div>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($parcel->status == 'pending'): ?>
                <div
                    ...
                    <form action="<?php echo e(route('customer.parcels.cancel', $parcel->id)); ?>" method="POST"
...
<?php echo $__env->make('layout.customer.CustomerLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/customer/parcels/show.blade.php ENDPATH**/ ?>