                            ...
                            <div class="flex flex-wrap items-center justify-between gap-4">
                                <div class="flex items-center gap-6">
                                    <div class="text-center">
                                        ...
                                        <p class="text-sm text-gray-500 font-medium mb-1"><?php echo e(\Carbon\Carbon::parse($trip->trip_date)->format('d/m/Y')); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($trip->route->departureLocation->name); ?></p>
                                    </div>
