            ...
            <div class="md:col-span-4">
                <div class="bg-white rounded-3xl shadow-sm p-8 text-center">
                    ...
                    <p class="text-amber-600 font-medium">
                        <?php echo e(Auth::user()->role === 'assistant' ? 'Phụ xe' : 'Tài xế chính'); ?>
...
<?php echo $__env->make('layout.driver.DriverLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\du-an-tot-nghiep\resources\views/driver/profile/profile.blade.php ENDPATH**/ ?>