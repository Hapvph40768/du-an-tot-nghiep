...
<?php $__env->startSection('header-title', 'THÊM GIÁ KÝ GỬI'); ?>
<?php $__env->startSection('header-subtitle', 'Cấu hình giá mới cho một tuyến và khoảng trọng lượng'); ?>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <form action="<?php echo e(route('admin.parcel_prices.store')); ?>" method="POST" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <optgroup label="<?php echo e($route->departureLocation->name ?? '...'); ?> → <?php echo e($route->destinationLocation->name ?? '...'); ?>">
                                        <option value="<?php echo e($route->id); ?>" <?php echo e(old('route_id') == $route->id ? 'selected' : ''); ?>>
                                            (ID: <?php echo e($route->id); ?>)
                                        </option>
                                    </optgroup>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="0.01" min="0" name="weight_from" id="weight_from" 
                                        value="<?php echo e(old('weight_from')); ?>" required
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="0.01" min="0" name="weight_to" id="weight_to" 
                                        value="<?php echo e(old('weight_to')); ?>" required
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Nhập mô tả thêm nếu cần (không bắt buộc)"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views\admin\parcel_prices\create.blade.php ENDPATH**/ ?>