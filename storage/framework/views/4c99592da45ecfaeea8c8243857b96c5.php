...
<head>
    <meta charset="UTF-8">
    <title>In Vé - Đơn #<?php echo e($booking->id); ?></title>
    <style>
...
<body>
    ...
    <div class="ticket-wrapper">
        <div class="ticket-header">
            <h1>VÉ ĐIỆN TỬ</h1>
            <p>Mã đơn: <strong>#<?php echo e($booking->id); ?></strong> • Ngày đặt: <?php echo e($booking->created_at->format('d/m/Y H:i')); ?></p>
        </div>
        ...
        <div class="ticket-body">
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <div class="info-value"><?php echo e($booking->contact_name); ?> (<?php echo e($booking->contact_phone); ?>)</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Trạng thái</div>
                    <div class="info-value" style="color: <?php echo e($booking->status == 'paid' ? '#22c55e' : '#f59e0b'); ?>">
                        <?php echo e(strtoupper($booking->status == 'paid' ? 'Đã thanh toán' : ($booking->status == 'pending' ? 'Chờ thanh toán' : 'Đã hủy'))); ?>

                    </div>
                </div>
                <div class="info-item">
                    <div class="info-label">Tuyến đường</div>
                    <div class="info-value"><?php echo e($booking->trip->route->startLocation->name ?? 'N/A'); ?> ➔ <?php echo e($booking->trip->route->endLocation->name ?? 'N/A'); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-label">Khởi hành</div>
                    <div class="info-value"><?php echo e(\Carbon\Carbon::parse($booking->trip->departure_time)->format('H:i')); ?> • <?php echo e(\Carbon\Carbon::parse($booking->trip->trip_date)->format('d/m/Y')); ?></div>
                </div>
                <div class="info-item" style="grid-column: span 2;">
                    <div class="info-label">Điểm đón</div>
                    <div class="info-value">
                        <strong><?php echo e($booking->pickupPoint->name ?? 'Tại bến'); ?></strong>
                        <span style="font-size: 0.9em; color: #64748b; font-weight: normal; margin-left: 5px;">(<?php echo e($booking->pickupPoint->address ?? 'Không có địa chỉ chi tiết'); ?>)</span>
                    </div>
                </div>
                <div class="info-item" style="grid-column: span 2;">
                    <div class="info-label">Điểm trả</div>
                    <div class="info-value">
                        <strong><?php echo e($booking->dropoffPoint->name ?? 'Tại bến'); ?></strong>
                        <span style="font-size: 0.9em; color: #64748b; font-weight: normal; margin-left: 5px;">(<?php echo e($booking->dropoffPoint->address ?? 'Không có địa chỉ chi tiết'); ?>)</span>
                    </div>
                </div>
                <div class="info-item" style="grid-column: span 2;">
                    <div class="info-label">Thông tin xe</div>
                    <div class="info-value">Biển số: <?php echo e($booking->trip->vehicle->license_plate ?? 'N/A'); ?> • Tài xế: <?php echo e($booking->trip->driver->name ?? 'N/A'); ?> (<?php echo e($booking->trip->driver->phone ?? 'N/A'); ?>)</div>
                </div>
            </div>
            ...
            <div class="ticket-section">
                ...
                <div class="tickets-list">
                    ...
                    <div class="qr-ticket">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo e(urlencode($ticket->ticket_code)); ?>" alt="QR" class="qr-img">
                        <div class="qr-code"><?php echo e($ticket->ticket_code); ?></div>
                    </div>
            ...
            <div class="ticket-section">
                ...
                <table class="pricing-table">
                    <tr>
                        <td>Giá vé (<?php echo e(number_format($booking->trip->price)); ?>đ x <?php echo e(max(1, $booking->tickets->count())); ?>)</td>
                        <td class="font-bold"><?php echo e(number_format($booking->trip->price * max(1, $booking->tickets->count()))); ?>đ</td>
                    </tr>
                    ...
                    <tr>
                        <td>Giảm giá</td>
                        <td class="text-success font-bold">-<?php echo e(number_format($booking->discount_amount)); ?>đ</td>
                    </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <tr>
                        <td>Tổng tiền vé</td>
                        <td class="font-bold"><?php echo e(number_format($baseTotal)); ?>đ</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-danger font-bold">+<?php echo e(number_format($penaltyFee)); ?>đ</td>
                    </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <tr class="total-row">
                        <td>TỔNG CỘNG</td>
                        <td><?php echo e(number_format($grossTotal)); ?>đ</td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <small>Hệ thống Quản lý Vé Xe Khách • In lúc <?php echo e(now()->format('H:i:s d/m/Y')); ?></small>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/bookings/export.blade.php ENDPATH**/ ?>