        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.pickup-points.index')); ?>"
                                class="text-decoration-none">Danh mục gốc</a></li>
                ...
                <div class="card shadow-sm border-0 rounded-4 p-4">
                    ...
                    <form
                        action="<?php echo e(route('admin.pickup-points.update', $pickupPoint->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="VD: Bến xe Miền Đông">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="d-flex gap-2 border-top pt-4">
                            ...
                            <a href="<?php echo e(route('admin.pickup-points.index')); ?>" class="btn btn-light border px-4 py-2"
                                style="border-radius: 8px;">Bỏ qua</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/pickup_points/edit.blade.php ENDPATH**/ ?>