    ...
    <div class="row g-4 mb-5">
        <div class="col-xl-3 col-md-6">
            <div class="card dash-card border-0 h-100 p-4">
                ...
                <h2 class="mb-1 fw-bold text-dark" style="font-size: 32px;"><?php echo e($totalDrivers); ?></h2>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card dash-card border-0 h-100 p-4">
                ...
                <h2 class="mb-1 fw-bold text-dark" style="font-size: 32px;"><?php echo e($totalTrips); ?></h2>
                <span class="badge bg-success bg-opacity-10 text-success fw-bold">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card dash-card border-0 h-100 p-4">
                ...
                <h2 class="mb-1 fw-bold text-dark" style="font-size: 32px;"><?php echo e($totalTickets); ?></h2>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card dash-card border-0 h-100 p-4">
                ...
                <h2 class="mb-1 fw-bold text-dark" style="font-size: 28px;"><?php echo e(number_format($totalRevenue, 0, ',', '.')); ?> đ</h2>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>