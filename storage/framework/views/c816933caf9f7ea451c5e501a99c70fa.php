        ...
        <div class="col-md-6">
            ...
            <div class="card shadow-sm border-0 rounded-4 p-4">
                <div class="mb-4">
                    ...
                    <p class="text-muted small"><?php echo e(__('locations')); ?> này sẽ được dùng chung để gán cho nhiều chuyến xe khác nhau.</p>
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold small text-muted"><?php echo e(__('name')); ?> điểm đón (Bến xe/Văn phòng)</label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold small text-muted"><?php echo e(__('address')); ?> chi tiết</label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="d-flex gap-2 border-top pt-4">
                        ...
                        <a href="<?php echo e(route('admin.pickup-points.index')); ?>" 
                           class="btn btn-light border px-4 py-2" style="border-radius: 8px;"><?php echo e(__('cancel')); ?></a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/pickup_points/create.blade.php ENDPATH**/ ?>