        ...
        <div class="grid md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-4">
                <div class="bg-white rounded-3xl shadow-sm p-8 text-center">
                    <div
                        class="w-32 h-32 mx-auto bg-blue-100 rounded-2xl flex items-center justify-center text-6xl border-4 border-white shadow-md">
                            ...
                            <div>
                                ...
                                <p class="font-medium flex items-center justify-center gap-2 mt-1">
                                    <span
                                        ...
                                        <?php echo e(Auth::user()->driver?->status === 'inactive' ? 'bg-blue-500' : 'bg-emerald-500'); ?>"></span>
            ...
            <div class="md:col-span-8">
                <div class="bg-white rounded-3xl shadow-sm p-8">
                    ...
                    <div class="mt-10 flex gap-4">
                        <a href="#"
                            class="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-center py-4 rounded-2xl font-medium transition">
                            Đổi mật khẩu
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layout.assistant.AssistantLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\du-an-tot-nghiep\resources\views/assistant/profile/profile.blade.php ENDPATH**/ ?>