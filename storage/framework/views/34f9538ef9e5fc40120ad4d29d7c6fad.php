...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mt-4 pt-3 border-top">
                        ...
                        <a href="<?php echo e(route('admin.schedules.index')); ?>" class="btn btn-light px-4 border">Hủy</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views\admin\schedules\create.blade.php ENDPATH**/ ?>