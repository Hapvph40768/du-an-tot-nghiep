            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                <div>
                    ...
                    <input type="text" name="name"
                        ...
                        value="<?php echo e(old('name', $driver->name)); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" name="experience_years"
                        style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;"
                        value="<?php echo e(old('experience_years', $driver->experience_years ?? 0)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <select name="status"
                        style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;"
                        required>
                        <option value="active" <?php echo e(old('status', $driver->status) == 'active' ? 'selected' : ''); ?>>
                            Đang hoạt động
                        </option>
                        <option value="busy" <?php echo e(old('status', $driver->status) == 'busy' ? 'selected' : ''); ?>>
                            Đang chạy
                        </option>
                        <option value="inactive" <?php echo e(old('status', $driver->status) == 'inactive' ? 'selected' : ''); ?>>
                            Đã nghỉ
                        </option>
                    </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="margin-bottom: 24px;">
                ...
                <textarea name="personal_info" rows="4"
                    style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; resize: vertical;"><?php echo e(old('personal_info', $driver->personal_info ?? '')); ?></textarea>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views\admin\drivers\edit.blade.php ENDPATH**/ ?>