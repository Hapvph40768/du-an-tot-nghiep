<?php $__env->startSection('title', 'Chi tiết Tuyến đường #' . $route->id); ?>
    ...
    <div class="mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center mt-2">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('admin.routes.edit', $route->id)); ?>" class="btn btn-outline-primary rounded-3 px-3">
            ...
            <div class="card-box mb-4">
                ...
                <div class="route-path">
                    <div class="location-box">
                        ...
                        <div class="location-name"><?php echo e($route->departureLocation->name); ?></div>
                    </div>
                    ...
                    <div class="location-box">
                        ...
                        <div class="location-name"><?php echo e($route->destinationLocation->name); ?></div>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6 border-end">
                        ...
                        <div class="info-value text-primary fs-4"><?php echo e($route->distance); ?> <span class="small fw-normal text-muted">km</span></div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-label"><i class='bx bx-time-five'></i> Thời gian hành trình dự kiến</div>
                        <div class="info-value text-primary fs-4"><?php echo e($route->duration); ?> <span class="small fw-normal text-muted">giờ</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-6 mb-3">
                        ...
                        <div class="fw-bold">#<?php echo e($route->id); ?></div>
                    </div>
                    <div class="col-6 mb-3">
                        <div class="info-label">Ngày khởi tạo</div>
                        <div class="fw-bold text-muted small"><?php echo e($route->created_at->format('d/m/Y H:i:s')); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views\admin\routes\show.blade.php ENDPATH**/ ?>