...
<style>
    ...
    .status-active { color: #059669; background: #ecfdf5; padding: 4px 10px; border-radius: 8px; font-weight: 600; font-size: 12px; }
    .status-maintenance { color: #dc2626; background: #fef2f2; padding: 4px 10px; border-radius: 8px; font-weight: 600; font-size: 12px; }
</style>
