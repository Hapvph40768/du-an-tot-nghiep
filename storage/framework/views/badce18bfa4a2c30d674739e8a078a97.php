...
<?php $__env->startSection('auth_title', 'Chào mừng trở lại'); ?>
<?php $__env->startSection('auth_subtitle', 'Vui lòng nhập thông tin để truy cập hệ thống'); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="pt-8 text-center border-t border-white/5">
            <p class="text-white/40 font-medium">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-brand-accent font-black hover:underline ml-2">ĐĂNG KÝ NGAY</a>
            </p>
        </div>
    </div>
