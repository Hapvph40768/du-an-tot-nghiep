...
<?php $__env->startSection('content-main'); ?>
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="<?php echo e(route('driver.trips.history')); ?>" class="px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-xl transition flex items-center gap-2">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < 7; $i++): ?>
                            ...
                            <button onclick="applyFilters()" data-date="<?php echo e($date->format('Y-m-d')); ?>"
                                class="date-btn flex-shrink-0 snap-center min-w-[74px] px-4 py-3.5 rounded-2xl font-medium transition-all text-center
                                        <?php echo e($i === 0 ? 'bg-amber-500 text-white shadow-md ring-2 ring-amber-200' : 'bg-white border border-gray-200 hover:border-amber-300 hover:shadow text-gray-700'); ?>">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex gap-3">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trip->status === 'active'): ?>
                                    <form action="<?php echo e(route('driver.trips.updateStatus', $trip)); ?>" method="POST" class="flex-1" style="display:flex">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.driver.DriverLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\du-an-tot-nghiep\resources\views/driver/trips/index.blade.php ENDPATH**/ ?>