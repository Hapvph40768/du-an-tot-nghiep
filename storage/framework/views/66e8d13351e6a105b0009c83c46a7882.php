...
<?php $__env->startSection('title', 'Chỉnh sửa điểm đón'); ?>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0 rounded-4 p-4">
                <div class="mb-4">
                    ...
                    <p class="text-muted small">Cập nhật thông tin cho: <span class="text-primary"><?php echo e($pickupPoint->name); ?></span></p>
                </div>

                <form action="<?php echo e(route('admin.pickup_points.update', $pickupPoint->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('address', $pickupPoint->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="pt-3 border-top d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.pickup_points.index')); ?>" class="btn btn-light px-4 border" style="border-radius: 10px;">Quay lại</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views\admin\trips\pickup_points\edit.blade.php ENDPATH**/ ?>