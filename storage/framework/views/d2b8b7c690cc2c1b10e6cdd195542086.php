    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow-sm border-0 rounded-4 p-4">
                <h3 class="fw-bold mb-4"><?php echo e(__('update')); ?> thông tin</h3>
                <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold small"><?php echo e(__('email')); ?></label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label fw-bold small"><?php echo e(__('role')); ?></label>
                    ...
                    <div class="mt-4 pt-3 border-top d-flex gap-2">
                        <button type="submit" class="btn btn-primary" style="background: #ff6b00; border:none; border-radius: 10px; padding: 10px 20px;"><?php echo e(__('update')); ?></button>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-light border" style="border-radius: 10px; padding: 10px 20px;"><?php echo e(__('back')); ?></a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>