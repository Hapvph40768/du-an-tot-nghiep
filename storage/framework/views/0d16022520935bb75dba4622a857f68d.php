...
<section class="py-12 lg:py-20 relative min-h-[80vh]">
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            ...
            <span class="inline-flex px-4 py-1.5 bg-white/5 text-white/70 border border-white/10 rounded-full font-mono text-sm shadow-inner">Đơn hàng #<?php echo e($booking->id); ?></span>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="lg:col-span-2 order-2 lg:order-1">
                <form action="<?php echo e(route('customer.payment.process', $booking->id)); ?>" method="POST" id="payment-form">
                    <?php echo csrf_field(); ?>
                ...
                <div class="sticky top-28 bg-white/5 border border-white/10 rounded-3xl p-6 relative overflow-hidden">
                    ...
                    <div class="space-y-4 text-sm mb-6">
                        <div class="flex flex-col gap-1">
                            ...
                            <span class="font-bold text-white text-lg"><?php echo e($booking->contact_name); ?></span>
                        </div>
                        <div class="flex flex-col gap-1">
                            <span class="text-white/50">Số điện thoại:</span> 
                            <span class="font-bold text-white"><?php echo e($booking->contact_phone); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="bg-black/20 rounded-2xl p-4 border border-white/5 mb-6">
                        <div class="flex items-center justify-between text-white/70 mb-2">
                            ...
                            <span><?php echo e(number_format($booking->total_amount, 0, ',', '.')); ?> đ</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-2xl font-black text-brand-primary"><?php echo e(number_format($booking->total_amount, 0, ',', '.')); ?> đ</span>
                        </div>
                    </div>
