        ...
        <div class="max-w-7xl mx-auto px-4 py-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('customer.home')); ?>" class="w-12 h-12 bg-amber-500 rounded-xl flex items-center justify-center hover:bg-amber-600 transition-colors">
                    ...
                    <div>
                        <a href="<?php echo e(route('customer.home')); ?>" id="brand-name" class="text-xl font-bold hover:text-amber-300 transition-colors block">Mạnh Hùng</a>
...
<?php /**PATH C:\laragon\www\du-an-tot-nghiep-main\resources\views/layout/customer/blocks/header.blade.php ENDPATH**/ ?>