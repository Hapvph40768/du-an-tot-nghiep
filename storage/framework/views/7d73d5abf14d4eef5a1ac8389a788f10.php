...
<?php $__env->startSection('header-title', 'CHỈNH SỬA GIÁ KÝ GỬI'); ?>
<?php $__env->startSection('header-subtitle', 'Cập nhật thông tin giá ký gửi'); ?>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="<?php echo e(route('admin.parcel_prices.update', $parcelPrice->id)); ?>" method="POST" novalidate>
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>

                        <div class="mb-4">
                            <label for="route_id" class="form-label fw-bold">Tuyến đường <span class="text-danger">*</span></label>
                            <select name="route_id" id="route_id" class="form-control form-control-lg <?php $__errorArgs = ['route_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <option value="<?php echo e($route->id); ?>" <?php echo e(old('route_id', $parcelPrice->route_id) == $route->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="0.01" min="0" name="weight_from" id="weight_from" 
                                        value="<?php echo e(old('weight_from', $parcelPrice->weight_from)); ?>" required
                                        class="form-control form-control-lg <?php $__errorArgs = ['weight_from'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['weight_from'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="0.01" min="0" name="weight_to" id="weight_to" 
                                        value="<?php echo e(old('weight_to', $parcelPrice->weight_to)); ?>" required
                                        class="form-control form-control-lg <?php $__errorArgs = ['weight_to'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['weight_to'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="1000" min="0" name="price" id="price" 
                                value="<?php echo e(old('price', $parcelPrice->price)); ?>" required
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $parcelPrice->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-5">
                            <a href="<?php echo e(route('admin.parcel_prices.index')); ?>" class="btn btn-lg btn-secondary">
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views\admin\parcel_prices\edit.blade.php ENDPATH**/ ?>