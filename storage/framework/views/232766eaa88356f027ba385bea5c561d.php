...
<div class="top-header">
    ...
    <div style="display: flex; gap: 12px;">
        ...
        <a href="<?php echo e(route('admin.routes.create')); ?>" style="background-color: #ff5b24; color: white; padding: 10px 20px; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; font-size: 14px; text-decoration: none;">+ Tạo tuyến xe</a>
    </div>
</div>
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <tr style="border-bottom: 1px solid #f0f2f5;">
                    ...
                    <td style="padding: 16px;"><?php echo e($route->startLocation->name ?? 'N/A'); ?></td>
                    <td style="padding: 16px;"><?php echo e($route->endLocation->name ?? 'N/A'); ?></td>
                    ...
                    <td style="padding: 16px; text-align: center;">
                        ...
                        <a href="<?php echo e(route('admin.routes.show', $route->id)); ?>" style="display: inline-block; background-color: #e6f7ff; color: #1890ff; padding: 6px 12px; border-radius: 6px; font-size: 12px; font-weight: 600; text-decoration: none; margin-right: 6px;">Xem</a>
                        <a href="<?php echo e(route('admin.routes.edit', $route->id)); ?>" style="display: inline-block; background-color: #fff7e6; color: #ff7a45; padding: 6px 12px; border-radius: 6px; font-size: 12px; font-weight: 600; text-decoration: none; margin-right: 6px;">Sửa</a>
                        
                        <form action="<?php echo e(route('admin.routes.destroy', $route->id)); ?>" method="POST" style="display: inline;">
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\du-an-tot-nghiep\resources\views/admin/routes/index.blade.php ENDPATH**/ ?>