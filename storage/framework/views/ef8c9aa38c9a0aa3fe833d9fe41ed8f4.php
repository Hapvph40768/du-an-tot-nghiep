        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <h2 class="fw-bold text-dark mt-2">Chỉnh sửa: <span
                        style="color: var(--primary-color);"><?php echo e($location->name); ?></span></h2>
            </div>
            <span class="badge bg-light text-dark border px-3 py-2 rounded-pill">ID: #<?php echo e($location->id); ?></span>
        </div>
        ...
        <div class="card-box">
            ...
            <form action="<?php echo e(route('admin.locations.update', $location->id)); ?>" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                        <input type="hidden" name="latitude" value="<?php echo e(old('latitude', $location->latitude)); ?>">
                        <input type="hidden" name="longitude" value="<?php echo e(old('longitude', $location->longitude)); ?>">
                        <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('name', $location->name)); ?>" placeholder="Ví dụ: Bến xe Mỹ Đình" required
                                autofocus>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('address', $location->address)); ?>" placeholder="Số nhà, đường, phường/xã...">
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('province_code', $location->province_code)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Ví dụ: Bến chính, có bãi đỗ xe lớn..."><?php echo e(old('note', $location->note ?? '')); ?></textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-check form-switch form-switch-lg">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active"
                                        value="1" <?php echo e(old('is_active', $location->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layout.admin.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Code\Tuan\du-an-tot-nghiep\resources\views/admin/locations/edit.blade.php ENDPATH**/ ?>