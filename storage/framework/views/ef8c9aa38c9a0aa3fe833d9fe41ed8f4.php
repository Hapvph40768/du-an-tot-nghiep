            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                <div style="grid-column: span 2;">
                    ...
                    <input type="text" name="name"
                        ...
                        value="<?php echo e(old('name', $location->name)); ?>" placeholder="Ví dụ: Bến xe Mỹ Đình" required autofocus>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text" name="city"
                        style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;"
                        value="<?php echo e(old('city', $location->city)); ?>" placeholder="Hà Nội, TP. Hồ Chí Minh, Đà Nẵng...">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text" name="province_code"
                        style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;"
                        value="<?php echo e(old('province_code', $location->province_code)); ?>" placeholder="HN, HCM, DN...">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="margin-bottom: 24px;">
                ...
                <textarea name="note" rows="4"
                    ...
                    placeholder="Ví dụ: Bến chính, có bãi đỗ xe lớn, gần trung tâm..."><?php echo e(old('note', $location->note ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="margin-bottom: 24px;">
                ...
                <select name="is_active"
                    style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;"
                    required>
                    <option value="1" <?php echo e(old('is_active', $location->is_active ? 1 : 0) == 1 ? 'selected' : ''); ?>>
                        Đang hoạt động
                    </option>
                    <option value="0" <?php echo e(old('is_active', $location->is_active ? 1 : 0) == 0 ? 'selected' : ''); ?>>
                        Tạm ngưng
                    </option>
                </select>
