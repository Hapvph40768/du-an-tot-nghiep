    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-72 bg-white border-r border-gray-200 flex flex-col shadow-xl z-50">
            ...
            <nav class="flex-1 px-3 py-6 overflow-y-auto">
                <ul class="space-y-1">
                    {{-- <li>
                        <a href="{{ route('assistant.home') }}"
                            class="{{ request()->routeIs('assistant.home') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' : 'text-gray-600 hover:bg-gray-50' }} 
                    ...
                    <li>
                        <a href="{{ route('assistant.trips.index') }}"
                            class="{{ request()->routeIs('assistant.trips.*') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' : 'text-gray-600 hover:bg-gray-50' }} 
                                    flex items-center gap-3 px-5 py-4 rounded-2xl font-medium transition-all">
                    ...
                    <li>
                        <a href="{{ route('assistant.history.index') }}"
                            class="{{ request()->routeIs('assistant.history.*') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' : 'text-gray-600 hover:bg-gray-50' }} 
                           flex items-center gap-3 px-5 py-4 rounded-2xl font-medium transition-all">
                    ...
                    <li>
                        <a href="{{ route('assistant.revenue.index') }}"
                            class="{{ request()->routeIs('assistant.revenue.*') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' : 'text-gray-600 hover:bg-gray-50' }} 
                           flex items-center gap-3 px-5 py-4 rounded-2xl font-medium transition-all">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header
                ...
                <div class="flex items-center gap-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-800">@yield('page-title', 'Assistant Portal')</h1>
                </div>
            </header>
