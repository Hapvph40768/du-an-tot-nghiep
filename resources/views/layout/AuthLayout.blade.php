...
<head>
    ...
    <title>@yield('title', 'Đăng nhập') - Nhà xe Mạnh Hùng</title>
            ...
            <div class="p-8 md:p-16 lg:p-20 bg-white/[0.02] flex flex-col justify-center relative">
                <div class="max-w-md mx-auto w-full space-y-10">
                    <div class="text-center lg:text-left space-y-3">
                        ...
                        <h1 class="text-3xl font-black tracking-tight">@yield('auth_title')</h1>
                        <p class="text-white/40 font-medium">@yield('auth_subtitle')</p>
                    </div>
