<footer class="bg-[#050505] border-t border-white/5 pt-16 pb-8 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <!-- Brand Info -->
            <div class="space-y-6">
                <a href="{{ route('customer.home') }}" class="flex items-center gap-3 group inline-flex">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="{{ url('/#search') }}" class="text-white/50 hover:text-white hover:pl-2 transition-all block">Đặt vé trực tuyến</a></li>
                    <li><a href="{{ route('customer.parcels.create') }}" class="text-white/50 hover:text-white hover:pl-2 transition-all block">Ký gửi hàng hóa</a></li>
