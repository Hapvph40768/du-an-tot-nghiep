...
<body class="bg-[#0a0a0a] text-white font-sans antialiased selection:bg-brand-primary/30" x-data="{ scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 20)">
