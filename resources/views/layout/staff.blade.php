        ...
        <nav class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-6">
                ...
                <div class="hidden lg:flex gap-4">
                    <a href="{{ route('staff.dashboard') }}" class="hover:text-blue-600 transition-colors {{ request()->routeIs('staff.dashboard') ? 'font-semibold border-b-2 border-blue-600' : '' }}">Tổng quan</a>
                    <a href="{{ route('staff.bookings.index') }}" class="hover:text-blue-600 transition-colors {{ request()->routeIs('staff.bookings.*') ? 'font-semibold border-b-2 border-blue-600' : '' }}">Đặt vé</a>
                    <a href="{{ route('staff.trips.index') }}" class="hover:text-blue-600 transition-colors {{ request()->routeIs('staff.trips.*') ? 'font-semibold border-b-2 border-blue-600' : '' }}">Chuyến xe</a>
