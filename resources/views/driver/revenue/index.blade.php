    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <div class="flex items-start gap-4">
                <a href="{{ route('driver.home') }}" class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-gray-500 hover:bg-amber-100 hover:text-amber-600 transition-colors mt-1">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            @foreach ($tripStats as $stat)
                                ...
                                <tr class="hover:bg-gray-50/80 transition-colors">
                                    ...
                                    <td class="py-5 px-8">
                                        <p class="font-medium text-gray-800">{{ \Carbon\Carbon::parse($trip->trip_date)->format('d/m/Y') }}}</p>
                                        <p class="text-xs text-gray-500 mt-1">{{ \Carbon\Carbon::parse($trip->departure_time)->format('H:i') }}}</p>
                                    </td>
