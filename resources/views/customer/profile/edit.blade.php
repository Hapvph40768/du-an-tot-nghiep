                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    @if(isset($bookings) && $bookings->isEmpty())
                        <div class="p-10 text-center text-gray-500">
                            ...
                            <a href="{{ route('customer.home') }}" class="inline-block bg-amber-50 text-amber-600 hover:bg-amber-100 border border-amber-200 font-medium py-2 px-6 rounded-lg transition-colors">Đặt vé ngay</a>
                        </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-left border-collapse whitespace-nowrap">
                                ...
                                <tbody class="divide-y divide-gray-100 text-sm">
                                    @foreach($bookings->take(5) as $booking) {{-- Hiển thị tối đa 5 vé mới nhất --}}
                                        <tr class="hover:bg-amber-50 transition-colors cursor-pointer" onclick="window.location='{{ route('customer.bookings.show', $booking->id) }}'">
