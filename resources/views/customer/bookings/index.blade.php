                            ...
                            @foreach($bookings as $booking)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="p-4 text-gray-700">
                                        {{ $booking->trip->route->departureLocation->name ?? '...' }}<span class="text-gray-400 mx-1">→</span> 
                                        {{ $booking->trip->route->destinationLocation->name ?? '...' }}</td>
                                    <td class="p-4 text-gray-700">
                                        {{ \Carbon\Carbon::parse($booking->trip->trip_date)->format('d/m/Y') }}<br>
