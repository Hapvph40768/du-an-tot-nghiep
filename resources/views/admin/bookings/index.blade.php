...
<style>
    :root { --primary-color: #ff6b00; --primary-hover: #e65100; }} .card-box { background: #ffffff; border-radius: 16px; padding: 24px; box-shadow: 0 5px 20px rgba(0,0,0,0.03); border: 1px solid #f0f0f0; }} .custom-table { width: 100%; border-collapse: separate; border-spacing: 0; table-layout: fixed; }} .custom-table thead th { background-color: #f9fafb; color: #6b7280; font-weight: 600; font-size: 11px; text-transform: uppercase; padding: 16px; border-bottom: 2px solid #edf2f7; }} .custom-table td { padding: 16px; vertical-align: middle; border-bottom: 1px solid #f3f4f6; font-size: 14px; }} /* Badge trạng thái đơn hàng */
    .badge-booking { padding: 6px 12px; border-radius: 20px; font-size: 11px; font-weight: 700; display: inline-block; }} .status-pending { background: #fff7ed; color: #c2410c; border: 1px solid #ffedd5; }} .status-paid { background: #f0fdf4; color: #15803d; border: 1px solid #dcfce7; }} .status-cancelled { background: #fef2f2; color: #b91c1c; border: 1px solid #fee2e2; }} .booking-id { font-family: 'Monaco', 'Consolas', monospace; color: #ff6b00; font-weight: 700; }} .price-total { font-weight: 800; color: #111827; }}</style>
