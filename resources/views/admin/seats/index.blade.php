...
<div class="container-fluid py-4">
    ...
    <div class="filter-section shadow-sm">
        <form action="{{ route('admin.seats.index') }}" method="GET" class="row g-3 align-items-end">
            ...
            @if(request('vehicle_id'))
                <div class="col-md-2">
                    <a href="{{ route('admin.seats.index') }}" class="btn btn-light border w-100 rounded-3">Xóa lọc</a>
                </div>
            @endif
        </form>
    </div>
    ...
    <div class="card-box">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="seat-badge">
                                    <i class='bx bx-chair'></i> {{ $seat->seat_number }}
                                </div>
                            </td>
                            <td>
        ...
        <div class="mt-4">
            {{ $seats->appends(request()->query())->links('pagination::bootstrap-5') }}
        </div>
    </div>
</div>
@endsection