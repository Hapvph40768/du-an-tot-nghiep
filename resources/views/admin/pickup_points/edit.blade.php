        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                {{-- Breadcrumb để dễ quay lại --}}<nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.pickup-points.index') }}"
                ...
                <div class="card shadow-sm border-0 rounded-4 p-4">
                    ...
                    {{-- Cập nhật route sang dấu gạch nối 'pickup-points' --}}<form
                        action="{{ route('admin.pickup-points.update', $pickupPoint->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        {{-- Tên điểm đón --}}<div class="mb-3">
                            ...
                            <input type="text" name="name" value="{{ old('name', $pickupPoint->name) }}"
                                class="form-control @error('name') is-invalid @enderror" placeholder="VD: Bến xe Miền Đông">
                        ...
                        <div class="d-flex gap-2 border-top pt-4">
                            ...
                            <a href="{{ route('admin.pickup-points.index') }}" class="btn btn-light border px-4 py-2"
