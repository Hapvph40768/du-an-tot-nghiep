...
<style>
    :root { --primary-color: #ff6b00; --primary-hover: #e65100; }} .card-box { background: #ffffff; border-radius: 16px; padding: 24px; box-shadow: 0 5px 20px rgba(0,0,0,0.03); border: 1px solid #f0f0f0; }} .route-path { display: flex; align-items: center; gap: 20px; margin-bottom: 30px; padding: 20px; background: #fff8f3; border-radius: 12px; border: 1px solid #ffe8d6; }} .location-box { text-align: center; flex: 1; }} .location-name { font-size: 18px; font-weight: 700; color: #111827; margin-top: 8px; }} .info-label { color: #6b7280; font-size: 13px; font-weight: 500; margin-bottom: 5px; }} .info-value { color: #111827; font-weight: 700; font-size: 16px; }} .arrow-icon { font-size: 32px; color: var(--primary-color); }}</style>
