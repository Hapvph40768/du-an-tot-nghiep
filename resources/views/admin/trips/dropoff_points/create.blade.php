...
<div class="container-fluid py-4">
    <div class="row justify-content-center">
        <div class="col-md-6">
            {{-- Breadcrumb để Admin biết mình đang ở đâu --}}
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.trips.index') }}" class="text-decoration-none">Chuyến xe</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.trips.pickup_points.index', $trip->id) }}" class="text-decoration-none">Điểm đón chuyến</a></li>
            ...
            <div class="card shadow-sm border-0 rounded-4 p-4">
                ...
                {{-- FORM ACTION: Gọi đúng hàm store_new của TripPickupPointController --}}
                <form action="{{ route('admin.trips.pickup_points.store_new', $trip->id) }}" method="POST">
                    ...
                    <div class="pt-3 border-top d-flex gap-2">
                        ...
                        {{-- Nút Hủy: Quay lại trang index của đúng Trip đó --}}
                        <a href="{{ route('admin.trips.pickup_points.index', $trip->id) }}" class="btn btn-light px-4 border" style="border-radius: 10px;">
                            Hủy bỏ
                        </a>
                    </div>
                </form>
