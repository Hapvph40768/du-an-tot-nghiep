...
<div class="container-fluid py-4">
    ...
    <form action="{{ route('admin.trips.dropoff_points.store', $trip->id) }}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="card shadow-sm border-0 rounded-4 p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('admin.dropoff-points.create') }}" target="_blank" class="text-primary small text-decoration-none fw-bold">+ Tạo điểm mới vào kho</a>
                    </div>
                    ...
                    <div class="scroll-area" style="max-height: 500px; overflow-y: auto;">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach($allDropoffPoints as $point)
                                <tr>
                                    <td>
                                        <input type="checkbox" name="dropoff_point_ids[]" value="{{ $point->id }}" 
                                               class="form-check-input" {{ $trip->dropoffPoints->contains($point->id) ? 'checked' : '' }}>
                                    </td>
                                    <td>
            ...
            <div class="col-md-5">
                <div class="card shadow-sm border-0 rounded-4 p-4 sticky-top" style="top: 20px;">
                    ...
                    <div class="bg-light p-3 rounded-3 mb-4">
                        @forelse($trip->dropoffPoints as $index => $p)
