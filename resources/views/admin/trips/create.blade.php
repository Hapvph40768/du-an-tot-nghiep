    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.trips.index') }}" class="text-decoration-none">Danh sách chuyến</a></li>
                ...
                <form action="{{ route('admin.trips.store') }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="route_id" class="form-select rounded-3 shadow-sm @error('route_id') is-invalid @enderror">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="driver_id" class="form-select rounded-3 @error('driver_id') is-invalid @enderror">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select rounded-3">
                                <option value="active" {{ old('status') == 'active' ? 'selected' : '' }}>Mở bán (Active)</option>
                                <option value="cancelled" {{ old('status') == 'cancelled' ? 'selected' : '' }}>Tạm dừng/Hủy</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 pt-3 border-top d-flex gap-2">
                        ...
                        <a href="{{ route('admin.trips.index') }}" class="btn btn-light px-4 border" style="border-radius: 10px;">
                            Hủy bỏ
                        </a>
                    </div>
                </form>
