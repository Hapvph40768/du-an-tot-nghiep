                    ...
                    <tbody>
                        @forelse ($trips as $trip)
                            <tr>
                                ...
                                <td>
                                    <div class="fw-bold text-primary" style="font-size: 15px;">{{ substr($trip->departure_time, 0, 5) }}</div>
                                    <div class="text-muted small mt-1">Đến dự kiến: {{ $trip->arrival_time ? substr($trip->arrival_time, 0, 5) : '—' }}</div>
                                </td>
                                <td>
