    ...
    <div class="container-fluid py-4">
        ...
        <div class="card-box">
            ...
            <div class="toolbar-area">
                ...
                <form action="{{ route('admin.vehicles.index') }}" method="GET" class="d-flex gap-3 flex-grow-1">
                    ...
                    <select name="status" class="form-select form-select-custom" style="width: 180px;"
                        ...
                        <option value="maintenance" {{ request('status') == 'maintenance' ? 'selected' : '' }}>Bảo dưỡng
                        </option>
                    </select>
                </form>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                <h6 class="mb-0 fw-bold vehicle-plate">{{ $vehicle->license_plate }}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="action-group">
                                            <a href="{{ route('admin.vehicles.edit', $vehicle->id) }}" class="action-btn"
                                                title="Chỉnh sửa">
                                            ...
                                            <form action="{{ route('admin.vehicles.destroy', $vehicle->id) }}"
                                                ...
                                                onsubmit="return confirm('Bạn có chắc chắn muốn xóa xe biển {{ $vehicle->license_plate }}?');">
                                                @csrf
                                                @method('DELETE')
            ...
            <div class="d-flex justify-content-between align-items-center mt-4 border-top pt-3">
                <small class="text-muted">
                    Đang hiển thị <strong>{{ $vehicles->count() }}</strong> trên tổng số
                    <strong>{{ $vehicles->total() }}</strong> xe
                </small>
